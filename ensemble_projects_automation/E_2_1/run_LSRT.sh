...
srun -o /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_1/%j_run.out -l --multi-prog /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_1/run.conf

# Run the second task (routing.conf) with only one task
srun --ntasks=1 -o /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_1/%j_routing.out -l --multi-prog /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_1/routing.conf
