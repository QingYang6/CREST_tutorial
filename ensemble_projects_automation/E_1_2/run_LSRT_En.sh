...
--FED /g/model/wrf/ensembles/2024-11-11-00/m2/grib2 \
--ROUT /g/model/hydro/hydrowork/CREST_work/dummy_projects/test_ensemble_out \
--FOD /g/model/hydro/hydrowork/CREST_work/dummy_projects/Ensemble_WRF/m2 \
--LoS single
...
sed -i 's|/ENSEMBLE_PATH|/g/model/hydro/hydrowork/CREST_work/dummy_projects/Ensemble_WRF/m2/2024111100UTC|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_1_2/forcing/forcing_WRFevent.txt
...
sed -i 's|SDATE|202411110030|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_1_2/run.project
sed -i 's|EDATE|202411141230|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_1_2/run.project
sed -i 's|WDATE|202411110130|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_1_2/run.project
sed -i 's|WRFM|m2|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_1_2/run.project
