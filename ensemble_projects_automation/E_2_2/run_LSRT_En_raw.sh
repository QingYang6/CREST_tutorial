...
sed -i 's|/ENSEMBLE_PATH|/g/model/hydro/hydrowork/CREST_work/dummy_projects/Ensemble_WRF/WRFNUM/SDATE_WRFUTC|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_2/forcing/forcing_WRFevent.txt
...
sed -i 's|SDATE|SDATE_RAW|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_2/run.project
sed -i 's|EDATE|EDATE_RAW|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_2/run.project
sed -i 's|WDATE|WDATE_RAW|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_2/run.project
sed -i 's|WRFM|WRFNUM|g' /g/model/hydro/hydrowork/CREST_work/dummy_projects/OP_ensemble/E_2_2/run.project
